...
public final class LightMapConstants {
    ...
    private static final int OPTIFINE_MAX_RESERVED_TEXTURE_SAMPLER = GL13.GL_TEXTURE0 + 40;
    public static final int R_LIGHT_MAP_SHADER_TEXTURE_SAMPLER_BINDING = OPTIFINE_MAX_RESERVED_TEXTURE_SAMPLER + 1;
    public static final int G_LIGHT_MAP_SHADER_TEXTURE_SAMPLER_BINDING = OPTIFINE_MAX_RESERVED_TEXTURE_SAMPLER + 2;
    public static final int B_LIGHT_MAP_SHADER_TEXTURE_SAMPLER_BINDING = OPTIFINE_MAX_RESERVED_TEXTURE_SAMPLER + 3;
